...
data class ReimbursementformModel(var category :String ="",var  categoryid:String ="",var country:String="",var countryid:String="",var currency:String="",var currencyid:String="",var amount:String=""
    ...
    fun isValiator() =   isempty(category) && isempty(country) &&isempty(currency) &&isempty(amount) && isempty(serviceperiod)&&listImage.isNotEmpty()  && isempty(ibannumber) /*&& isempty(accountnumber)*/ && isempty(bankname)&&isempty(beneficiary)&&isempty(accounttype)
