...
data class ReimbursementformModel(var category :String ="",var  categoryid:String ="",var country:String="",var countryid:String="",var currency:String="",var currencyid:String="",var amount:String=""
                                  ,var serviceperiod :String ="",var beneficiary :String ="",var bankname :String ="",var accountnumber :String ="",var ibannumber :String ="",var accounttype :String ="",var swiftcode :String ="",var listImage: ArrayList<ListImage> = ArrayList()):
    BaseValidatorClass() {
